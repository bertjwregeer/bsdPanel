...
void bsdPanelNet::DomainName::initGlobalCodes() {
    ...
    globalCodes.push_back("org");
    globalCodes.push_back("edu");
    globalCodes.push_back("mil");
